...
//    public static ServiceDetails dtoToServiceDetailsEntity(ServiceDetailsDto dto) {
...
//    }
    ...
    public static List<ServiceDetails> serviceDtoToEntity(List<ServiceDetailsDto> serviceDetails) {
    	return serviceDetails.stream().map(s->ServiceDetails.builder()
    			.packageCost(s.getPackageCost())
    ...
    public static ServiceDetailsDto serviceEntityToDto(ServiceDetails details) {
    	return ServiceDetailsDto.builder()
    			.customerRegId(details.getCustomerRegister().getCustomerRegId())
    			.vehicleRegId(details.getVehicleRegister().getVehicleRegId())
    			.serviceId(details.getServiceId())
    			.serviceDescription(details.getServiceDescription())
    			.packageName(details.getPackageName())
    			.packageCost(details.getPackageCost())
    			.build();
    }
    public static List<Booking> bookingDtoToEntity(List<BookinDto> list) {
        return list.stream().map(b->Booking.builder().bookingTime(b.getBookingTime())
    ...
    public static BookinDto bookingEntityToDto(Booking entity) {
        return BookinDto.builder()
        		.customerRegId(entity.getCustomerRegister().getCustomerRegId()).bookingTime(entity.getBookingTime())
        		.bookingId(entity.getBookingId())
                .bookingDate(entity.getBookingDate())
                .build();
    }
    public static List<VehicleRegistration> vehicleDtoToEntity(List<VehicleRegistrationDto> list){
    	return list.stream().map(v-> VehicleRegistration.builder()
    			.vehicleRegId(v.getVehicleRegId())
    ...
    public static VehicleRegistrationDto vehicleEntityToDto(VehicleRegistration entity) {
		return VehicleRegistrationDto.builder().vehicleRegId(entity.getVehicleRegId())
				.customerRegId(entity.getCustomerRegister().getCustomerRegId())
